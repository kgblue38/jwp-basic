...
public class RequestMapping {
	...
	void initMapping() {
		...
		mappings.put("/qna/update", new QuestionUpdateController());
		mappings.put("/qna/delete", new QuestionDeleteController());
		mappings.put("/api/qna/delete", new QuestionDeleteController());
